...
- (void)refresh
{
    ...
    if (upcomingMedia) {
        ...
        [self.imageView srg_requestImageForObject:upcomingMedia withScale:SRGImageScaleLarge aspectRatio:SRGLetterboxDefaultAspectRatio type:SRGImageTypeDefault];
