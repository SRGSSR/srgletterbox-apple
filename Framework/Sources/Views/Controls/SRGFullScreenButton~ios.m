...
static void commonInit(SRGFullScreenButton *self)
{
    [self setImage:[UIImage imageNamed:@"fullscreen" inBundle:NSBundle.srg_letterboxBundle compatibleWithTraitCollection:nil] forState:UIControlStateNormal];
    [self setImage:[UIImage imageNamed:@"cancel_fullscreen" inBundle:NSBundle.srg_letterboxBundle compatibleWithTraitCollection:nil] forState:UIControlStateSelected];
}
