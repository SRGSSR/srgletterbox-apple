...
- (instancetype)initWithURN:(nullable NSString *)URN standalone:(BOOL)standalone serviceURL:(nullable NSURL *)serviceURL updateInterval:(nullable NSNumber *)updateInterval;
