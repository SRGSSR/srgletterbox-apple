...
- (instancetype)initWithURN:(nullable NSString *)URN chaptersOnly:(BOOL)chaptersOnly serviceURL:(nullable NSURL *)serviceURL updateInterval:(nullable NSNumber *)updateInterval;
