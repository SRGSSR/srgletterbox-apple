...
let package = Package(
    ...
    dependencies: [
        ...
        .package(name: "SRGAnalytics", url: "https://github.com/SRGSSR/srganalytics-apple.git", .upToNextMajor(from: "7.1.1")),
        .package(name: "SRGAppearance", url: "https://github.com/SRGSSR/srgappearance-apple.git", .upToNextMajor(from: "4.0.1")),
